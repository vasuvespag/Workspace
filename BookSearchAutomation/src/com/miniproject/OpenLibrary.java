...
public class OpenLibrary {
	public static void main(String[] args) throws InterruptedException {
		...
		//navigate to home page of the application for finding details of the books.
		...
		System.out.println("Number of books in Romance category is "+ f1.getText());
		...
		WebElement h=driver.findElement(By.xpath("//div[@data-slick-index='7']/*/*[2]"));
		System.out.println(h.getText());
		WebElement h1=driver.findElement(By.xpath("//div[@data-slick-index='7']/*/*[3]"));
		System.out.println("Number of books in Children category is "+ h1.getText());
		...
		System.out.println("Number of books in History category is "+ i1.getText());
		...
		System.out.println("Number of books in Medicine category is "+ j1.getText());
		...
		System.out.println("Number of books in Religion category is "+ k1.getText());
		...
		System.out.println("Number of books in Mystery And Detective Stories category is "+ l1.getText());
		...
		System.out.println("Number of books in Plays category is "+ m1.getText());
		...
		System.out.println("Number of books in Music category is "+ n1.getText());
		...
		System.out.println("Number of books in Science category is "+ o1.getText());
