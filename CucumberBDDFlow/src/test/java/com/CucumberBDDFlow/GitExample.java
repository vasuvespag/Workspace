...
"Executables\\chromedriver.exe");
    ...
    public void i_should_be_seeing_new_profile_picture(){
        ...
        if(!(sb.equals(sa)))
        {
        AssertJUnit.assertTrue("File Upload successful", true);
        }
        // Write code here that turns the phrase above into concrete actions
    }
    ...
    public void i_provide_filename_description() throws InterruptedException {
        // Write code here that turns the phrase above into concrete actions
     driver.findElement(By.xpath("//div[@class='editcontainer']/div[@id='gists']/input")).sendKeys("Gist1");
     Thread.sleep(2000);
     Actions actions = new Actions(driver);
     WebElement element = 
