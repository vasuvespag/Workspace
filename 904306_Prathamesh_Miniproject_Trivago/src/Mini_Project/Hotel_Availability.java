...
/******* System setting details ***************/
		...
		/************Verify whether the city entered in placeholder****************/	 
			...
			//Fetch the city from input_data file 
			 ...
			 //driver.findElement(By.xpath("//input[@id='input-auto-complete']")).sendKeys(Keys.DOWN);
			 driver.findElement(By.xpath("//input[@id='input-auto-complete']")).sendKeys(Keys.ENTER);
			 try {
